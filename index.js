...
function check(form) {
    ...
    else if (form.userid.value == "1902900310042" && form.pswrd.value == "12345") {
        window.open('studentlist/shivank.html')
    }
    else if (form.userid.value == "abesit.faculty" && form.pswrd.value == "12345") {
        window.open('studentlist/teachers.html')
    }
    else {
